...
public class BPMNDiagramGlyph implements ShapeGlyph {
    ...
    public static final BPMNDiagramGlyph INSTANCE = new BPMNDiagramGlyph();
    private static final double WIDTH = 50;
    private static final double HEIGHT = 50;
    private Group group = new Group();

    public BPMNDiagramGlyph() {
        final Rectangle rectangle = new Rectangle(WIDTH, HEIGHT)
                .setStrokeWidth(0.5)
                .setFillGradient(ShapeUtils.getLinearGradient("#000000", "#FFFFFF", WIDTH, HEIGHT));
        group.add(rectangle);
    }
