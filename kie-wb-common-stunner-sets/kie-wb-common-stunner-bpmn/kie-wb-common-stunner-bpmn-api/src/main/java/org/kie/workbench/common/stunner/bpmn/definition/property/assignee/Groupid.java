...
import org.kie.workbench.common.stunner.core.definition.annotation.property.Property;
...
@Bindable
@Property
public class Groupid implements BPMNProperty {

    @Caption
    public static final transient String caption = "Groups";

    @Description
    public static final transient String description = "The groups responsible for executing the human task";
