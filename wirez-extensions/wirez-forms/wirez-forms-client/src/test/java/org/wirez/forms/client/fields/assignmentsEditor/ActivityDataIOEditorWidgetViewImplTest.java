...
public class ActivityDataIOEditorWidgetViewImplTest {
    ...
    public void testInit() {
        view.init(presenter);
        verify(button, times(1)).setText(WirezFormsClientFieldsConstants.INSTANCE.Add());
    ...
    public void testOnlySingleEntryAllowed() {
        ...
        assertEquals(WirezFormsClientFieldsConstants.INSTANCE.Only_single_entry_allowed(), eventCaptor.getValue().getNotification());
    }
