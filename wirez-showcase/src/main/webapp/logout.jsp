...
<head>
    ...
    <link rel="stylesheet" href="org.wirez.WirezShowcase/css/patternfly.min.css">
    <link rel="stylesheet" href="org.wirez.WirezShowcase/css/patternfly-additions.min.css">
</head>
...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-5 col-lg-4 login">
            ...
            <form class="form-horizontal" role="form" action="<%= request.getContextPath() %>/wirez.html" method="post">
