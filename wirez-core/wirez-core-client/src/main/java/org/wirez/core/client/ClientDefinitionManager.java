...
public class ClientDefinitionManager extends BaseDefinitionManager {
    ...
    public void init() {
        ...
        Collection<IOCBeanDef<ModelFactory>> modelBuilderDefs = beanManager.lookupBeans(ModelFactory.class);
        for (IOCBeanDef<ModelFactory> modelBuilder : modelBuilderDefs) {
