...
@Portable
@Bindable
@Definition( type = Node.class, builder = UserIcon.UserIconBuilder.class )
...
public class UserIcon implements StaticIcon {
    ...
    @Title
    public static final transient String title = "User Icon";

    @Description
    public static final transient String description = "User Icon";
    ...
    @NonPortable
    public static class UserIconBuilder implements Builder<UserIcon> {
