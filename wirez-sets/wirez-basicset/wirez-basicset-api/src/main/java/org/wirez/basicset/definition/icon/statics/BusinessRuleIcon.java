...
@Portable
@Bindable
@Definition( type = Node.class, builder = BusinessRuleIcon.BusinessRuleIconBuilder.class )
...
public class BusinessRuleIcon implements StaticIcon {
    ...
    @Title
    public static final transient String title = "Business Rule Icon";

    @Description
    public static final transient String description = "Business Rule Icon";
    ...
    @NonPortable
    public static class BusinessRuleIconBuilder implements Builder<BusinessRuleIcon> {
