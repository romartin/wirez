...
public class ConnectorGlyph implements ShapeGlyph {

    public static final ConnectorGlyph INSTANCE = new ConnectorGlyph();
    private Group group = new Group();

    public ConnectorGlyph() {
        final Arrow arrow = new Arrow(new Point2D(0, 50), new Point2D(50, 0), 5, 10, 45, 45, ArrowType.AT_END)
                .setStrokeWidth(5).setStrokeColor(Connector.COLOR).setDraggable(true);
        group.add(arrow);
    }
