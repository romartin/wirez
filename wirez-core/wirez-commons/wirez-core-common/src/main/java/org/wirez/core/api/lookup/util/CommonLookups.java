package org.wirez.core.api.lookup.util;
...
import org.wirez.core.api.lookup.rule.RuleLookupRequestImpl;
...
public class CommonLookups {
    ...
    public <T> Set<String> getAllowedDefinitions(final String defSetId,
                                                 final org.wirez.core.api.graph.Graph<?, ? extends Node> graph,
                                                 final Node<? extends Definition<T>, ? extends Edge> sourceNode,
                                                 final String edgeId,
                                                 final int page,
                                                 final int pageSize) {
    ...
    public <T> boolean isCardinalitySatisfied( final String defSetId,
                                               final org.wirez.core.api.graph.Graph<?, ? extends Node> target,
                                               final T sourceDefinition ) {
