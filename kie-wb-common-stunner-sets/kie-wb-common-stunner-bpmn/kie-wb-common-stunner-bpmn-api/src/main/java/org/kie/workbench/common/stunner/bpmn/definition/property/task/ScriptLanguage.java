...
@Bindable
@Property
public class ScriptLanguage implements BPMNProperty {
    @Caption
    public static final transient String caption = "ScriptLanguage";

    @Description
    public static final transient String description = "The script language.";
