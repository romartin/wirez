...
import org.kie.workbench.common.stunner.basicset.shape.def.PolygonWithIconShapeDefImpl;
...
@Shape( factory = BasicShapesFactory.class, def = PolygonWithIconShapeDefImpl.class )
