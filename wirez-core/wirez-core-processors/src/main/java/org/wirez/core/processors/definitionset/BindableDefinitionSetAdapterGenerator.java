...
import org.wirez.core.api.definition.adapter.binding.BindableDefinitionSetAdapter;
...
public class BindableDefinitionSetAdapterGenerator extends AbstractBindableAdapterGenerator {
    ...
    public StringBuffer generate(String packageName, String className,
        ...
        addFields("graphTypes", root, processingDefinitionSetAnnotations.getGraphTypes());
        addFields("graphFactories", root, processingDefinitionSetAnnotations.getGraphFactories());
