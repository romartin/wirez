...
/**
 * This perspective is used for showing other widgets from the wirez-widgets-sandbox module.
 */
@ApplicationScoped
@WorkbenchPerspective( identifier = "WirezSandboxPerspective", isTransient = false )
public class WirezSandboxPerspective {

    public static final String PERSPECTIVE_ID = "WirezSandboxPerspective";
    ...
    public PerspectiveDefinition buildPerspective() {
        ...
        perspective.setName( "Wirez sandbox" );
