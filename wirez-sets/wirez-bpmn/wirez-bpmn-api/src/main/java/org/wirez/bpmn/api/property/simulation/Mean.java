...
@Bindable
@Property
public class Mean extends BaseProperty implements BPMNProperty {

    public static final String ID = "mean";
    ...
    public Mean() {
        super(ID, "Processing time (mean)", "Processing time (mean)", false, false);
    }
