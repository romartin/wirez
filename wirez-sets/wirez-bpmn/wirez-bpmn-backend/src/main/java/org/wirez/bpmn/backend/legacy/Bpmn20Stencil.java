 ...
 */
package org.wirez.bpmn.backend.legacy;
...
public enum Bpmn20Stencil {
    ...
    IntermediateErrorEventCatching(Bpmn2Package.eINSTANCE.getIntermediateCatchEvent(), Bpmn2Package.eINSTANCE.getErrorEventDefinition()),
