...
public class Actors implements BPMNProperty {
    ...
    @Caption
    public static final transient String caption = "Actors";

    @Description
    public static final transient String description = "The actors responsible for executing the human task";
