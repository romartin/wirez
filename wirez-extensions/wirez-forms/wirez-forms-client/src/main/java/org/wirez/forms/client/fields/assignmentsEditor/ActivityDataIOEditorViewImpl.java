...
public class ActivityDataIOEditorViewImpl extends BaseModal implements ActivityDataIOEditorView {
    ...
    public void init(final Presenter presenter) {
        ...
        setTitle( WirezFormsClientFieldsConstants.INSTANCE.Data_IO() );

        inputAssignmentsWidget.setVariableType( VariableType.INPUT );
        inputAssignmentsWidget.setAllowDuplicateNames(false, WirezFormsClientFieldsConstants.INSTANCE.A_Data_Input_with_this_name_already_exists());
        ...
        btnSave = new Button( WirezFormsClientFieldsConstants.INSTANCE.Save() );
        ...
        btnCancel = new Button( WirezFormsClientFieldsConstants.INSTANCE.Cancel() );
    ...
    public void setCustomViewTitle(String name) {
        setTitle(name + " " + WirezFormsClientFieldsConstants.INSTANCE.Data_IO());
    }
    ...
    public void setPossibleInputAssignmentsDataTypes(List<String> dataTypeDisplayNames) {
        ListBoxValues dataTypeListBoxValues = new ListBoxValues(AssignmentListItemWidgetView.CUSTOM_PROMPT, WirezFormsClientFieldsConstants.INSTANCE.Edit() + " ", presenter.dataTypesTester());
    ...
    public void setInputAssignmentsProcessVariables(List<String> processVariables) {
        ListBoxValues processVarListBoxValues = new ListBoxValues(AssignmentListItemWidgetView.CONSTANT_PROMPT, WirezFormsClientFieldsConstants.INSTANCE.Edit() + " ", presenter.processVarTester(), CONSTANT_MAX_DISPLAY_LENGTH);
    ...
    public void setOutputAssignmentsProcessVariables(List<String> processVariables) {
        ListBoxValues processVarListBoxValues = new ListBoxValues(AssignmentListItemWidgetView.CONSTANT_PROMPT, WirezFormsClientFieldsConstants.INSTANCE.Edit() + " ", presenter.processVarTester());
        processVarListBoxValues.addValues(processVariables);
    ...
    public void setInputAssignmentsDisallowedNames(Set<String> names) {
        inputAssignmentsWidget.setDisallowedNames(names, WirezFormsClientFieldsConstants.INSTANCE.This_input_should_be_entered_as_a_property_for_the_task());
    }
}
