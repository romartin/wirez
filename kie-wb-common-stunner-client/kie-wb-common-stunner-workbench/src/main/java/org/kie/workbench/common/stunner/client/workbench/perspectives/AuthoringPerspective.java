 ...
 */
package org.kie.workbench.common.stunner.client.workbench.perspectives;

import com.google.gwt.user.client.Timer;
import org.kie.workbench.common.stunner.client.workbench.screens.*;
...
public class AuthoringPerspective {
    ...
    public void onStartup(final PlaceRequest placeRequest) {
        ...
        // if ( null == this.placeRequest ) {
            ...
            if ( isOpenCanvas( sourceParams ) ) {
                ...
                cloneParams( sourceParams, params, "uuid" );
                ...
                new Timer() {
                    ...
                    @Override
                    public void run() {
                        PlaceRequest canvasScreenPlaceRequest = new DefaultPlaceRequest( CanvasScreen.SCREEN_ID , params );
                        placeManager.goTo(canvasScreenPlaceRequest);
                    }
    ...
    private boolean isOpenCanvas( final Map<String, String> params ) {
        ...
        if ( null != params && !params.isEmpty() ) {
            ...
            return params.containsKey( "uuid" ) || params.containsKey( "defSetId" );
