...
public interface AssignmentListItemWidgetView extends HasModel<AssignmentRow>  {
    ...
    String CUSTOM_PROMPT = WirezFormsClientFieldsConstants.INSTANCE.Custom() + ListBoxValues.EDIT_SUFFIX;
    String ENTER_TYPE_PROMPT = WirezFormsClientFieldsConstants.INSTANCE.Enter_type() + ListBoxValues.EDIT_SUFFIX;
    String CONSTANT_PROMPT = WirezFormsClientFieldsConstants.INSTANCE.Constant() + ListBoxValues.EDIT_SUFFIX;
    String ENTER_CONSTANT_PROMPT = WirezFormsClientFieldsConstants.INSTANCE.Enter_constant() + ListBoxValues.EDIT_SUFFIX;
