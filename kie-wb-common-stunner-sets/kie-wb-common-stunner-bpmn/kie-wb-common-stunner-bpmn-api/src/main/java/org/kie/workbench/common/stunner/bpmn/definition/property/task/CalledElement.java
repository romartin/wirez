...
@Bindable
@Property
public class CalledElement implements BPMNProperty {
    @Caption
    public static final transient String caption = "CalledElement";

    @Description
    public static final transient String description = "The called element";
