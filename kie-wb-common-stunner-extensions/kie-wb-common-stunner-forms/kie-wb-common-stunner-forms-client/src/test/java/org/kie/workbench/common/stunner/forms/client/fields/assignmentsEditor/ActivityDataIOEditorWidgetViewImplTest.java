...
package org.kie.workbench.common.stunner.forms.client.fields.assignmentsEditor;
...
import org.kie.workbench.common.stunner.forms.client.fields.model.AssignmentRow;
import org.kie.workbench.common.stunner.forms.client.fields.resources.i18n.StunnerFormsClientFieldsConstants;
...
public class ActivityDataIOEditorWidgetViewImplTest {
    ...
    public void testInit() {
        view.init(presenter);
        verify(button, times(1)).setText( StunnerFormsClientFieldsConstants.INSTANCE.Add());
    ...
    public void testOnlySingleEntryAllowed() {
        ...
        assertEquals( StunnerFormsClientFieldsConstants.INSTANCE.Only_single_entry_allowed(), eventCaptor.getValue().getNotification());
    }
