...
@Bindable
@Property
public class Actor implements BPMNProperty {

    @Caption
    public static final transient String caption = "Actor";

    @Description
    public static final transient String description = "The actor";
    ...
    public Actor(final String value ) {
        this.value = value;
    }
