...
import org.wirez.client.widgets.palette.simple.Simple;
...
@Dependent
@WorkbenchScreen(identifier = PaletteSimpleScreen.SCREEN_ID )
public class PaletteSimpleScreen {

    private static final int _WIDTH = 70;
    public static final String SCREEN_ID = "PaletteSimpleScreen";
    ...
    private void open() {
        if (null != shapeSetId && shapeSetId.trim().length() > 0) {
            palette.show( _WIDTH, shapeSetId,
    ...
    public String getMyContextRef() {
        return "wirezPaletteSimpleScreenContext";
    }
