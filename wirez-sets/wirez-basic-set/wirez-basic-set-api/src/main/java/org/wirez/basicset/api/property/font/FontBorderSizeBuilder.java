...
public class FontBorderSizeBuilder extends BasePropertyBuilder<Integer> {
    
    public static final String PROPERTY_ID = "fontBorderSize";
    
    public FontBorderSizeBuilder() {
        super(PROPERTY_ID, new IntegerType());
        this.caption("Font border size")
            .description("The font border size")
            .optional(true)
            .readOnly(false)
            .publish(true)
            .defaultValue(1);
