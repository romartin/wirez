...
public class ActivityDataIOEditorWidgetViewImpl extends Composite implements ActivityDataIOEditorWidgetView {
    ...
    public void init(Presenter presenter) {
        ...
        addVarButton.setText(WirezFormsClientFieldsConstants.INSTANCE.Add());
        addVarButton.setIcon(IconType.PLUS);
        nameth.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Name());
        datatypeth.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Data_Type());
    }

    @Override
    public void showOnlySingleEntryAllowed() {
        notification.fire(new NotificationEvent(WirezFormsClientFieldsConstants.INSTANCE.Only_single_entry_allowed(), NotificationEvent.NotificationType.ERROR));
    }
    ...
    public void setTableTitleInputSingle() {
        tabletitle.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Data_Input_and_Assignment());
    }

    @Override
    public void setTableTitleInputMultiple() {
        tabletitle.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Data_Inputs_and_Assignments());
    }

    @Override
    public void setTableTitleOutputSingle() {
        tabletitle.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Data_Output_and_Assignment());
    }

    @Override
    public void setTableTitleOutputMultiple() {
        tabletitle.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Data_Outputs_and_Assignments());
    }

    @Override
    public void setProcessVarAsSource() {
        processvarorconstantth.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Source());
    }

    @Override
    public void setProcessVarAsTarget() {
        processvarorconstantth.setInnerText(WirezFormsClientFieldsConstants.INSTANCE.Target());
    }
