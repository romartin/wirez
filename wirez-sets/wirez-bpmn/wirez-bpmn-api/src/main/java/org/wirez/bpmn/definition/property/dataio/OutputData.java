...
@Bindable
@Property
public class OutputData implements BPMNProperty {

    @Caption
    public static final transient String caption = "Output Data";

    @Description
    public static final transient String description = "Data Output from the Activity";
    ...
    public OutputData( final String value ) {
        this.value = value;
    }
