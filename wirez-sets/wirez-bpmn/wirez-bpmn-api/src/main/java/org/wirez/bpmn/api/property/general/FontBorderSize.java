...
@Bindable
@Property
public class FontBorderSize implements BPMNProperty {

    @Caption
    public static final String caption = "Font border size";

    @Description
    public static final String description = "The font border size";
