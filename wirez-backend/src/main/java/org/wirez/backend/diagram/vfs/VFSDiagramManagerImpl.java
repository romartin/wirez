package org.wirez.backend.diagram.vfs;
...
import org.wirez.backend.definition.marshall.DefaultDiagramMarshaller;
        ...
        try {
            ...
            if ( null == services ) {
                ...
                try {
                    ...
                    // ********** Save the diagram **********************++
                    LOG.info( "Saving diagram with UUID [" + uuid + "] using path [" + diagramPath + "]" );
                    ...
                    try {
                        ...
                        if ( null != thumbData ) {
                            ...
                            LOG.info( "Saving thumbnail for diagram with UUID [" + uuid + "] into path [" + thumbPath + "]" );
