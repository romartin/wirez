...
public class AssignmentData {
    ...
    public void setVariableCountsString(boolean hasInputVars, boolean isSingleInputVar, boolean hasOutputVars, boolean isSingleOutputVar) {
        ...
        if (hasInputVars) {
            ...
            {
                if (isSingleInputVar) {
                    sb.append(WirezFormsClientFieldsConstants.INSTANCE.No_Data_Input());
                }
                else {
                    sb.append("0 " + WirezFormsClientFieldsConstants.INSTANCE.Data_Inputs());
                }
            }
            else if (inputAssignments.size() == 1) {
                sb.append("1 " + WirezFormsClientFieldsConstants.INSTANCE.Data_Input());
            }
            else if (inputAssignments.size() > 1) {
                sb.append(inputAssignments.size() + " "  + WirezFormsClientFieldsConstants.INSTANCE.Data_Inputs());
            }
        ...
        if (hasOutputVars) {
            ...
            if (outputAssignments == null || outputAssignments.isEmpty())
            {
                if (isSingleOutputVar) {
                    sb.append(WirezFormsClientFieldsConstants.INSTANCE.No_Data_Output());
                }
                else {
                    sb.append("0 " + WirezFormsClientFieldsConstants.INSTANCE.Data_Outputs());
                }
            }
            else if (outputAssignments.size() == 1) {
                sb.append("1 " + WirezFormsClientFieldsConstants.INSTANCE.Data_Output());
            }
            else if (outputAssignments.size() > 1) {
                sb.append(outputAssignments.size() + " "  + WirezFormsClientFieldsConstants.INSTANCE.Data_Outputs());
            }
        }
