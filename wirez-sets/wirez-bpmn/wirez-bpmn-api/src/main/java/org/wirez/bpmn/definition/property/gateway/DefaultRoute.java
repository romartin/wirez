...
@Bindable
@Property
public class DefaultRoute implements BPMNProperty {

    @Caption
    public static final transient String caption = "Default route";

    @Description
    public static final transient String description = "The gateway's default route";
    ...
    public DefaultRoute( final String value ) {
        this.value = value;
    }
