...
@Dependent
public class DiagramExplorerItem implements IsWidget {

    private static Logger LOGGER = Logger.getLogger(DiagramExplorerItem.class.getName());
    
    public interface View extends UberView<DiagramExplorerItem> {
    ...
    @Inject
    public DiagramExplorerItem(final ShapeManager shapeManager,
                               final View view) {
