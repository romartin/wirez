...
package org.kie.workbench.common.stunner.client.widgets.property;
...
public class PropertiesEditor implements IsWidget {
    ...
    public interface EditorCallback {
        void onShowElement( Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element );
    }
    ...
    protected void show( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element ) {
        assert element != null;
        ...
        // Show the categories.
        view.handle( new PropertyEditorEvent( "stunnerPropertiesEditorEvent", categories ) );
    ...
    @SuppressWarnings( "unchecked" )
    private PropertyEditorCategory buildPropertiesCategory( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element,
    ...
    @SuppressWarnings( "unchecked" )
    private PropertyEditorFieldInfo buildGenericFieldInfo( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element,
    ...
    private PropertyEditorCategory buildElementCategory( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element ) {
    ...
    private void executeUpdateProperty( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element,
                                        final String propertyId,
                                        final Object value ) {
        execute( canvasCommandFactory.UPDATE_PROPERTY( element, propertyId, value ) );
    }

    private void executeMove( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element,
                              final double x,
                              final double y ) {
    ...
    private double getWidth( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element ) {
    ...
    private double getHeight( final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element ) {
        final Bounds.Bound ul = element.getContent().getBounds().getUpperLeft();
        final Bounds.Bound lr = element.getContent().getBounds().getLowerRight();
    ...
    void onCanvasElementSelectedEvent( @Observes CanvasElementSelectedEvent event ) {
        ...
        if ( null != uuid ) {
            ...
            final Element<? extends org.kie.workbench.common.stunner.core.graph.content.view.View<?>> element = this.canvasHandler.getGraphIndex().get( uuid );
            show( element );
