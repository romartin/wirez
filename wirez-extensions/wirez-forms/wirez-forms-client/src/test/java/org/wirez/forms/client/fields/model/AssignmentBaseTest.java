...
public class AssignmentBaseTest {
    ...
    public void setUp() throws Exception {
        ...
        final WirezFormsClientFieldsConstants constants = PowerMockito.mock(WirezFormsClientFieldsConstants.class, answer);
        setFinalStaticField(WirezFormsClientFieldsConstants.class.getDeclaredField("INSTANCE"), constants);
