...
public class ActivityDataIOEditorViewImplTest {
    ...
    public void testSetInputAssignmentsDisallowedNames() {
        ...
        verify(inputAssignmentsWidget).setDisallowedNames(names, WirezFormsClientFieldsConstants.INSTANCE.This_input_should_be_entered_as_a_property_for_the_task());
    }
