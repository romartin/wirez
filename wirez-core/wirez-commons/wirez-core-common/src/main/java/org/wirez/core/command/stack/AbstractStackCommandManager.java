...
import org.wirez.core.command.batch.BatchCommandResultBuilder;
...
public abstract class AbstractStackCommandManager<C, V> extends AbstractBatchCommandManager<C,V>
    implements StackCommandManager<C,V> {
