...
/**
 * A Command to add a graph shape to a Graph and add the corresponding canvas shapes.
 */
public class AddCanvasGraphCommand extends BaseCanvasCommand {

    Graph candidate;
    ShapeFactory factory;

    public AddCanvasGraphCommand(final GraphCommandFactory commandFactory, final Graph candidate, final ShapeFactory factory ) {
    ...
    public String toString() {
        return "AddCanvasGraphCommand [graph=" + candidate.getUUID() + ", factory=" + factory + "]";
    }
